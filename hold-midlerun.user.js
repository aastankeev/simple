...
// @version     124
// @description fix_08-11-2024; 11-11-2024; 12-11-2024; 09-12-2024; 19-12-2024; 20-12-2024; 10-01-2025; 31-01-2025
...
(function() {
    const clickButton = () => {
        const button = document.querySelector('div._btn_1mwk4_90 button._button_1mfca_1._primary_1mfca_28._normal_1mfca_259');
        if (button) {
    ...
    async function getBuildingDetails() {
        ...
        for (let i = 0; i < tabs.length; i++) {
            ...
            const buildings = Array.from(document.querySelectorAll('div._main_ih83i_105')).map(building => {
                const name = building.querySelector('div._title_ih83i_78').textContent.trim();
                const upgradeButton = building.querySelector('button._button_1mfca_1._upgrade_1mfca_66');
                const horoscopeButton = building.querySelector('button._button_1mfca_1._horoscope_1mfca_120');
                const buildButton = building.querySelector('button._button_1mfca_1._action__1mfca_48');
                ...
                const growthItems = Array.from(building.querySelectorAll('div._growthItem_180p0_26')).map(item => {
                    const title = item.querySelector('div._title_ih83i_78')?.textContent.trim();
        ...
        if (ratings.length > 0) {
            ...
            for (let i = 0; i < tabs.length; i++) {
                ...
                if (tabTitle === topBuilding.group) {
                    ...
                    const buildingElement = Array.from(document.querySelectorAll('div._title_ih83i_78')).find(el => el.textContent.includes(topBuilding.name));
    ...
    function clickButtonBasedOnType() {
        ...
        const buildButtonSelector =   'div._detailActions_10u6o_1 button._button_1mfca_1._action_1mfca_48._normal_1mfca_259';
        const upgradeButtonSelector = 'div._detailActions_10u6o_1 button._button_1mfca_1._upgrade_1mfca_66._normal_1mfca_259';
        const eventButtonSelector =   'div._detailActions_10u6o_1 button._button_1mfca_1._horoscope_1mfca_120._normal_1mfca_259';
